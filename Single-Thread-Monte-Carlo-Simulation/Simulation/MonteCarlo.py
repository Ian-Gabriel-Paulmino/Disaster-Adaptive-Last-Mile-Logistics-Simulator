...
class MonteCarloSimulation:
    ...
    def __init__(self, G, start_node, delivery_nodes, ideal_delivery_time ,base_speed_mpm=500, num_delivery_points=7):
        """
    ...
    def run_simulation(self, num_simulations=100, weather_severity=3):
        ...
        for i in range(num_simulations):
            ...
            if (i + 1) % 1 == 0:  # Print every simulation
                print(f"Progress: {self.completed_simulations}/{num_simulations} "
