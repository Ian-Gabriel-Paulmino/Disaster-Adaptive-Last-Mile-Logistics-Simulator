...
class MonteCarloSimulationWorker:
    ...
    def get_rainfall_probability_by_condition(self, weather_severity):
        return {
            # 1: [0.85, 0.1, 0.04, 0.009, 0.001],
            # 2: [0.6, 0.25, 0.1, 0.04, 0.01],
            # 3: [0.3, 0.3, 0.25, 0.1, 0.05],
            # 4: [0.1, 0.15, 0.25, 0.25, 0.25],
            # 5: [0.01, 0.04, 0.15, 0.35, 0.45]
            ...
            5: [0.005, 0.02, 0.075, 0.35, 0.55]    # Dominated by extreme events
        }[weather_severity]
